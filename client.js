const gameId = '1d55a2c4-f1b2-4960-8f78-9487ac164479';
...
const apiServer = 'http://192.168.0.101/';
const socket = io.connect(apiServer, {reconnect: true, transports: ['websocket']});
const playerId = '9728f232-51e9';
const optionJoin = {game_id: gameId, player_id: "9728f232-51e9-4fc2-87e5-e0ddcc09cda3"}
